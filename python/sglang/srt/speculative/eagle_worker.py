...
class EAGLEWorker(TpModelWorker):
    ...
    def _draft_preprocess_decode(self, batch: ScheduleBatch):
        ...
        # Save out_cache_loc for deferred free (after draft GPU work completes).
        # We cannot free here because draft_forward still needs these slots.
        self._draft_out_cache_loc = out_cache_loc
    ...
    def draft(self, batch: ScheduleBatch):
        ...
        # Free the temporarily allocated draft cache slots after GPU work.
        with self.allocator_lock:
            self.token_to_kv_pool_allocator.free(self._draft_out_cache_loc)
